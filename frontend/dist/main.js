...
/* harmony import */ var _shared_services_httpcall_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/services/httpcall.service */ "./src/app/shared/services/httpcall.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_shared__WEBPACK_IMPORTED_MODULE_9__["AuthGuard"], _shared_services_httpcall_service__WEBPACK_IMPORTED_MODULE_10__["HttpcallService"], _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_11__["AuthService"], _shared_services_token_service__WEBPACK_IMPORTED_MODULE_12__["TokenService"]],
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TokenService", function() { return _services__WEBPACK_IMPORTED_MODULE_3__["TokenService"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HttpcallService", function() { return _services__WEBPACK_IMPORTED_MODULE_3__["HttpcallService"]; });
...
/* harmony import */ var _token_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./token.service */ "./src/app/shared/services/token.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./src/app/shared/services/httpcall.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/shared/services/httpcall.service.ts ***!
  \*****************************************************/
...
var HttpcallService = /** @class */ (function () {
    ...
    HttpcallService.prototype.login = function (data) {
        return this.http.post(this.baseUrl + "/login", data);
    };
    HttpcallService.prototype.sendPasswordResetLink = function (data) {
...
/*!******************************************!*\
  !*** ./src/app/shared/services/index.ts ***!
  \******************************************/
/*! exports provided: AuthService, TokenService, HttpcallService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _token_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./token.service */ "./src/app/shared/services/token.service.ts");
...
/* harmony import */ var _httpcall_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./httpcall.service */ "./src/app/shared/services/httpcall.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HttpcallService", function() { return _httpcall_service__WEBPACK_IMPORTED_MODULE_2__["HttpcallService"]; });
...
var TokenService = /** @class */ (function () {
    ...
    TokenService.prototype.handle = function (token, user) {
        this.set(token, user);
        // this.set(user);
    };
    TokenService.prototype.set = function (token, user) {
